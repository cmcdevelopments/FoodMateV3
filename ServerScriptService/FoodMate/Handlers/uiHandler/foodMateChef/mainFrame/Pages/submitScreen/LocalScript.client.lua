...
script.Parent:GetPropertyChangedSignal("Visible"):Connect(function()
	if script.Parent.Visible == true then
		local closeTween = tweenService:Create(script.Parent.Parent.Parent.sideBar.close, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {ImageTransparency=1})
		closeTween:Play()
		closeTween.Completed:Connect(function()
			script.Parent.Parent.Parent.sideBar.close.Visible = false
			script.Parent.Parent.Parent.sideBar.pages.Visible = false
		end)
		...
		script.Parent.Parent.Parent.Parent.Scripts.clickHandler.pageChange:Fire("changePage", script.Parent.Parent.orderScreen)
		script.Parent.Parent.Parent.sideBar.close.Visible = true
		script.Parent.Parent.Parent.sideBar.pages.Visible = true
		local closeTween2 = tweenService:Create(script.Parent.Parent.Parent.sideBar.close, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {ImageTransparency=0})
		closeTween2:Play()
	end
end)