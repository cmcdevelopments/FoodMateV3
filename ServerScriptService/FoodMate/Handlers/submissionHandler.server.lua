...
game.ReplicatedStorage.foodMateSetup.remotes.serverTime.OnServerInvoke = function()
	return tick()
end

game.ReplicatedStorage.foodMateSetup.remotes.orderSubmit.OnServerEvent:Connect(function(plr, encode1, encode2, request, customer, playertoken)
