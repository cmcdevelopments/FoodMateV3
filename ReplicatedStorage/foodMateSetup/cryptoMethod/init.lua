--fyi, no this isn't a crypto miner for those confused, it's a method for us to encrypt remotes for small vulnerabilities such as an exploiter spamming  the remotes and pretending a certain staff member submitted tons of invalid orders in an attempt to get them fired
